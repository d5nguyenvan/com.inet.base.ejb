...
public final class Preconditions {
  ...
  /**
   * Ensures that a {@code value} String object passed as a parameter to calling method is not null
   * and contains the data.
   *
   * @param value the String value to check.
   * @return the non-null {@code value} String object that was validated.
   * @throws IllegalArgumentException if {@code value} is {@code null} or empty String.
   */
  ...
  /**
   * Ensures that a {@code value} String object passed as a parameter to calling method is not
   ...
   * @throws IllegalArgumentException if {@code value} is {@code null} or empty String.
   */
  public static String checkNotEmpty(String value, Object errorMessage) {
    if (value == null || value.isEmpty()) {
      throw new IllegalArgumentException(String.valueOf(errorMessage));
    }
    return value;
  ...
  /**
   * Ensures that a {@code value} String object passed as a paramter to calling method is not
   * null and contains the data.
   *
   * @param value the String value to check.
   * @param errorMessageTemplate a template for the exception message should the
   ...
   * @throws IllegalArgumentException if {@code value} is {@code null} or empty String.
   */
  public static String checkNotEmpty(String value, String errorMessageTemplate,
      Object...errorMessageArgs) {
    if (value == null || value.isEmpty()) {
